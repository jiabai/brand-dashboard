...
CREATE TABLE IF NOT EXISTS `qa_brand_state` (
  ...
  `keyword` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '生成question的关键词，用户提交job时系统会根据关键词生成question',
  `is_mentioned` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Whether the brand is mentioned in the answer',
  ...
  `sentiment_status` varchar(20) NOT NULL DEFAULT 'unknown' COMMENT 'Sentiment status (positive, negative, neutral, unknown)',
