...
集中暴露数据库查询函数，调用方无需关心 engine 获取逻辑。
engine 在此模块内部通过 get_engine() 获取，不泄漏到调用方。
"""
...
def query_brand_metrics(tenant_key, job_id, start_date, end_date, brand=None, platform=None):
    return _brand_metrics(get_engine(), tenant_key, job_id, start_date, end_date, brand, platform)
...
def query_brand_platform_keyword_daily_mention_rates(
    ...
    return _daily_rates(
        get_engine(), tenant_key, job_id, brand, platform, keyword, start_date, end_date
    )
...
def query_brand_platform_mention_data(
    ...
    return _platform_mention(
        get_engine(), tenant_key, job_id, brand, category, keyword, timeframe, specific_date
    )


def query_platform_metrics_by_brand(tenant_key, job_id, brand, start_date, end_date):
    return _platform_metrics(get_engine(), tenant_key, job_id, brand, start_date, end_date)


def query_post_citation_rate(tenant_key, job_id, brand, start_date, end_date):
    return _post_cite_rate(get_engine(), tenant_key, job_id, brand, start_date, end_date)
...
def query_domain_citation_rate(
    ...
    return _domain_cite_rate(
        get_engine(), tenant_key, job_id, brand, start_date, end_date, keyword, platform
    )


def query_citation_url_stats(tenant_key, job_id, keyword, domain, start_date, end_date):
    return _cite_url_stats(
        get_engine(), tenant_key, job_id, keyword, domain, start_date, end_date
    )


def query_citation_type_stats(tenant_key, job_id, start_date, end_date):
    return _cite_type_stats(get_engine(), tenant_key, job_id, start_date, end_date)


def query_domain_citation_summary(tenant_key, job_id, brand, start_date, end_date):
    return _domain_cite_summary(get_engine(), tenant_key, job_id, brand, start_date, end_date)


def get_available_dates(tenant_key, job_id=None):
    return _available_dates(get_engine(), tenant_key, job_id)


def query_filter_metadata(tenant_key, job_id, start_date=None, end_date=None):
    return _filter_metadata(get_engine(), tenant_key, job_id, start_date, end_date)


def query_keyword_platform_brand_rates(tenant_key, job_id, start_date, end_date):
    return _kw_platform_brand_rates(get_engine(), tenant_key, job_id, start_date, end_date)